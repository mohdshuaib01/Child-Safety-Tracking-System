...
<head>
    ...
    <title>Registered Users Registry - Admin Panel</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="viewUsers.jsp" class="active"><i class="fas fa-users"></i> Users Grid</a>
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    <h2 class="fw-bold m-0 text-dark">
                        <i class="fas fa-users text-primary me-2"></i> Registered Accounts Registry
                    </h2>
                    <p class="text-muted small mb-0 mt-1">Audit profile matrices, security authentication tags, and contact metadata points.</p>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            <thead style="background: #0f172a; color: white;">
                                <tr>
                                    <th class="ps-4 py-3">Master ID</th>
                                    <th class="py-3">Account Full Name</th>
                                    <th class="py-3">Email Address Token</th>
                                    <th class="pe-4 py-3">Phone Terminal Log</th>
                                </tr>
                            </thead>
                            <tbody>
    <%
    ...
    %>
    <tr>
        <td class="ps-4 fw-semibold text-primary">#<%= rs.getInt("user_id") %></td>
        <td class="fw-medium text-dark">
            <i class="far fa-user text-black-50 me-1 small"></i> <%= rs.getString("full_name") %>
        </td>
        <td class="fw-medium"><i class="far fa-envelope text-muted me-1 small"></i> <%= rs.getString("email") %></td>
        <td class="pe-4 text-secondary">
            <i class="fas fa-phone-flip text-muted me-1 small"></i> <%= rs.getString("phone") %>
        </td>
    </tr>
    <%
        }
    ...
    <tr>
        <td colspan="4" class="text-center py-5 text-muted">
            <i class="fas fa-users-slash fa-3x mb-3 text-black-50 d-block"></i>
            No registered user master accounts found inside the system data arrays.
        </td>
    </tr>
    <%
        }
